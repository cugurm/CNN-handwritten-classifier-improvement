...
\begin{abstract}
  ...
  We tested our method on two relevant real-world datasets -- NIST Special Database 19 and ETH Zurich Deepwriting dataset. We achieve up to 2.7\% improvement in classification precision and get state of the art results on these datasets.
\end{abstract}
