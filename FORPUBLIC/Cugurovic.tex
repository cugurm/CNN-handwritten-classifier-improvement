...
After this initial attempt, different groups of researchers worked on this problem for decades \citep{plamondon}.\marginpar{Uz ovakvu recenicu mora vise referenci iz razlicitih vremenskih perioda. Potrazi.}
...
\marginpar{Svuda: koristi citep kada dajes referencu za samostalno zaokruzenu tvrdnju. Takodje, grupisi vise referenci u jedne zagade. Koristi citet kada koristis referencu kao imenicu unutar recenice. Ja sam izmenio na par mesta, proveri ostala.}
...
\marginpar{Nije bas jasno sta je razlika izmedju toga da mreze prepoznaju tekst i da su deo slozenih sistema koji se ticu prepoznavanja teksta. Pojasni.}
...
\cite{}.\marginpar{Milane, dodaj reference na ovakve pristupe.}
