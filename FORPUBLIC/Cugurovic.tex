...
and even some of the problems of recognizing offline handwritten characters.
...
A committee of seven CNNs obtains precision of $88.12\%$ \citet{nist1}. All CNNs are trained in full online mode with changing learning rate and other importan parameters. 
For committee forming training is conducted on the original and six preprocessed datasets (Preprocessing is motivated by writing style
variations resulting in different aspect ratios of the handwritten characters). % FIKS OVOGA

% Deepwriting rezultati
There are currently no published results of the classification problem on the Deepwriting dataset. 

% Najbolji rezultati generalno
pass

% Poboljsanje generalno
In terms of publications related to improving the offline handwritten character recognition, 
none of them focuses on the writing style of the individual users, which is the basic idea that motivated our improvement method. 
However, there are papers that work to improve the various types of offline handwritten text classifiers.
