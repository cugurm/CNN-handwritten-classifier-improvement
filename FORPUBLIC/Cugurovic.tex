...
We consider their average to be %a "wrong" 
...
\begin{itemize}
  ...
  \end{itemize}
  \item Based on the previous go through of all of the images of the adaptation set the confidence vectors for the base CNN and auxiliary KNN classifiers were set; we use them further in the next step % Da li da brisem ovaj bullet, on nije korak??
...
The classifier confidence vector is an array of beta distributions %expectations, 
